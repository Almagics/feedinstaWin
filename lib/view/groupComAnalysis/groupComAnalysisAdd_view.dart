  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title:  Center(child: Text(getTranslated(context, 'entergroupana'), style: TextStyle(
          fontSize: 20,
              ...
              children: [
                ...
                Container(
                  ...
                  child:  Padding(padding: EdgeInsets.all(AppPadding.p8),
                    child: Center(child: Text(getTranslated(context, 'entergroupana'))),
                ...
                Padding(padding: EdgeInsets.all(AppPadding.p8),
                    child: AppTextFormFiled(
                     ...
                     // hintText: getTranslated(context, 'groupName'),
                    )
                ),
